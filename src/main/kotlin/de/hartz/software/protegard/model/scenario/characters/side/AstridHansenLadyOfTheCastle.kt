...
class AstridHansenLadyOfTheCastle : Character("Astrid Hansen", Rooms.lobbyRoom) {
    ...
    val DENIED_STUDY_ROOM_KEY: Dialog by lazy {
            ...
            Dialog(
                ...
                Dialog(
                    ...
                    callback = {
                        // TODO: Better to assign the dialogs directly?
                        GameController.gamestate.setReached(Milestone.MISSION_TO_GET_KEY_TO_STUDY_ROOM)
    ...
    val GRANTED_STUDY_ROOM_KEY: Dialog =
        Dialog(
